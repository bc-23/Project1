...
object Main extends App {
  ...
  def showMenu() = {
    ...
    while (option != 7) {
      ...
      option match {
        case 1 => println("case 1 worked")
        //Problem Scenario 1: Question 1: ONE PHYSICAL TABLE -DO NOT  RUN LINE  66 AGAIN-1115974 at 10-50 am
        ...
        //output =  5099141  - do not run these codes again
            case 2 => println("case 2 worked")

        //Problem Scenario 2:Question 3: What is the least consumed beverage on Branch2?
        ...
        spark.sql("SELECT drink, sum(totalcount) totcount FROM Branch1Constotcount3  GROUP BY drink ORDER BY totcount DESC LIMIT 1").show(1)
        //Miid_Capuccino 3288074
        //Problem Scenario 2 Question: What is the least consumed beverage on Branch2::
         spark.sql("SELECT drink, sum(totalcount) totcount FROM Branch2Constotcount3  GROUP BY drink ORDER BY totcount ASC").show(1)
        //cold mocha 47524
        //Problem Scenario 2:Question : Average of beverage count in Branch 2
        spark.sql("SELECT * FROM Branch2Constotcount3").show(5)
        spark.sql("SELECT ROUND(avg(totalcount)) FROM Branch2Constotcount3").show()

        case 3 => println("case 3 worked")
        //Question 6: Beverage on branch 10, 8 and 1
        //Problem Scenario 3 - Question 1:
        ...
        //  spark.sql("CREATE TABLE IF NOT EXISTS Branch10Branch8Branch1drink3 AS SELECT drink, branch from (SELECT * from Bev_BranchA3 where branch ='Branch10' or branch ='Branch8' or branch ='Branch1' UNION ALL SELECT * FROM Bev_BranchB3 where branch = 'Branch10' or branch ='Branch8' or branch = 'Branch1' UNION ALL SELECT * FROM Bev_BranchC3 where branch = 'Branch10' or branch = 'Branch8' or branch ='Branch1')UnionResult")
           spark.sql("SELECT * FROM Branch10Branch8Branch1drink3 order by drink").show(5)
        spark.sql("SELECT * FROM Branch10Branch8Branch1drink3").show(5)
        //println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
          ////Problem Scenario 3 - Question 2:
  ...
  //old codes - not needed for now - Codes to create merged Branch A, B, and C table
